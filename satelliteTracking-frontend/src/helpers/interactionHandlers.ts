...
import { createVisibilityErrorResetState, buildVisibilitySummaryInfo } from './visibilityFlowHelpers'
import { extractAuthErrorMessage } from './appErrorHelpers'

export function createHandleSearchResultSelect(options: {
  ...
  return async function handleSearchResultSelect(item: any) {
...
export function createHandleReportSighting(options: {
  ...
  return async function handleReportSighting() {
...
export function createHandleCalculateVisibility(options: {
  ...
  return async function handleCalculateVisibility() {
...
export function createHandleFocusBySatelliteId(options: {
  ...
  return function handleFocusBySatelliteId(passOrId: any) {
